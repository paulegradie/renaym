...
// NOTE: macOS and Linux temporarily hidden while we work on code signing verification
const allPlatforms: Omit<PlatformDownload, 'icon'>[] = [
  ...
  // Temporarily hidden - will be restored once code signing is complete
            ...
            <div className="flex-1">
              ...
              <div className="space-y-2 text-sm text-zinc-400">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <span><strong className="text-zinc-300">macOS & Linux:</strong> Coming soon! We&apos;re working on verified code signing for all platforms.</span>
                </div>
                <div className="flex items-start gap-2">
